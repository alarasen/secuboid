...
public record RecipientEverybody(@NotNull RecipientType type,
                                 long id
) implements Recipient {

    // Needed for load from database
    @SuppressWarnings({"unused", "java:S1172", "java:S1130"})
    public static RecipientEverybody newInstance(@NotNull RecipientType type, long id,
                                                 @Nullable String value) throws RecipientException {
        return new RecipientEverybody(type, id);
    }
