...
//
//        flagTypeService = new FlagTypeServiceImpl();
//        ((FlagTypeServiceImpl) flagTypeService).init(pluginLoader);
//    }
//
//    @Test
//    void when_get_flag_type_then_return_it() {
//        FlagType flagType = flagTypeService.getFlagType(FLAG_NAME_TEST);
//
...
//        Set<String> flagTypeNames = flagTypeService.getFlagTypeNames();
//
