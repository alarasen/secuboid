...
import me.tabinol.secuboid.api.messages.MessageFormater;
import me.tabinol.secuboid.api.messages.MessageManager;
...
public class MessageManagerImpl implements MessageManager {
    ...
    public String get(MessageType messageType, MessagePath path) {
        ...
        if (format == null) {
            ...
            log().log(Level.WARNING, () -> format("[Plugin:%s] %s", pluginName, message));
            return message;
        }
    ...
    private FileConfiguration getFileConfiguration(String lang, String langFilename, String defaultLangFilename) {
        ...
        if (inputStream == null) {
            log().log(Level.SEVERE, () -> format("[Plugin:%s] No language file found", pluginName));
