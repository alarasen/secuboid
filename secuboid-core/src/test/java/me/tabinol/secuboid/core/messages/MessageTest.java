 ...
 */
package me.tabinol.secuboid.core.messages;
...
import me.tabinol.secuboid.api.messages.MessageColor;
import me.tabinol.secuboid.api.messages.MessagePath;
import me.tabinol.secuboid.api.messages.MessageType;
import me.tabinol.secuboid.core.flags.FlagDeclarations;
...
class MessageTest {
    ...
    void when_send_two_paramaters_return_it() {
        ...
        String message = message().get(MessageType.NORMAL, messagePath);
    ...
    void when_no_color_do_not_format() {
        MessagePath messagePath = MessagePaths.generalTest(1.23, "p2");
        String message = message().get(MessageType.NO_COLOR, messagePath);
    ...
    void when_send_error_prefix_it() {
        MessagePath messagePath = MessagePaths.generalTest(1.23, "p2");
        String message = message().get(MessageType.ERROR, messagePath);
    ...
    void when_get_flag_descrition_return_it() {
        String message = message().getFlagDescription(FlagDeclarations.FLAG_BUILD);
